...
import net.tdfp.procedures.PhytochemicalMilkshakeusedProcedure;
...
public class PhytochemicalMilkshakeItem extends Item {
	public PhytochemicalMilkshakeItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		PhytochemicalMilkshakeusedProcedure.execute(entity);
