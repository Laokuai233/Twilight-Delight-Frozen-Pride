...
import net.tdfp.procedures.TorchberryIceCreamUsedProcedure;
...
public class TorchberryIceCreamItem extends Item {
	public TorchberryIceCreamItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		TorchberryIceCreamUsedProcedure.execute(entity);
