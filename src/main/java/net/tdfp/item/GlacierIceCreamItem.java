...
import net.tdfp.procedures.GlacierIceCreamUsedProcedure;
...
public class GlacierIceCreamItem extends Item {
	public GlacierIceCreamItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		GlacierIceCreamUsedProcedure.execute(entity);
