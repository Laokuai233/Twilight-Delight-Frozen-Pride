...
import net.tdfp.procedures.TorchberryMilkshakeUsedProcedure;
...
public class TorchberryMilkshakeItem extends Item {
	public TorchberryMilkshakeItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		TorchberryMilkshakeUsedProcedure.execute(entity);
